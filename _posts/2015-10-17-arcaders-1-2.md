...
```rust
//? Note: the <'pump> annotation is no longer necessary.
pub struct Events<'ev_ctx> {
    pump: EventPump<'ev_ctx>
}
```

But what are these `<'ev_ctx>` all over the place?
...
```rust
fn event_pump<'ev_ctx>(&'ev_ctx mut self) -> EventPump<'ev_ctx>;
```
...
<!--https://web.archive.org/web/20170621235954/https://www.owasp.org/index.php/Using_freed_memory-->
<!--https://web.archive.org/web/20170628183142/http://blog.skylight.io/rust-means-never-having-to-close-a-socket-->
