...
> follow the instructions given by [`rust-sdl2`'s README file](https://github.com/Rust-SDL2/rust-sdl2#sdl20-development-libraries).
...
You know the drill! We are creating a canvas, which we will later use to
...
is tradition in the Rust world, although it may _look weird_, the `canvas`
